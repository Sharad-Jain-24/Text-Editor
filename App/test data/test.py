...
class Notepad:
    ...
    def __init__(self, **kwargs):
        ...
        self.__HMenu.add_command(label="About", compound=LEFT, accelerator='Ctrl+ALt+A')#, command=self.__)
        self.__HMenu.add_command(label="Shortcuts", compound=LEFT, accelerator='Ctrl+ALt+S')#, command=self.__)
        self.__HMenu.add_command(label="Update", compound=LEFT, accelerator='Ctrl+ALt+U')#, command=self.__)
        self.__Menu.add_cascade(label="Help", menu=self.__HMenu)
    ...
    def __open(self, _event=None):
        ...
        if self.__file == "":
            ...
            try:
                ...
                messagebox.showerror("Error", "Can't Open this File Format")
                self.__newf()
            """
